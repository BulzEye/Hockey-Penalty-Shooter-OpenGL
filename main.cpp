...
void draw_disk()//creates seating for stadium as well as field
{
	...
	gluDisk(myDisk, 24 ,25, 4, 1);
	glPopMatrix();
	gluDisk(myDisk, 24 ,25, 4, 1);
	glColor3f(0.3f, 0.3f, 0.3f);
	glPushMatrix();
	glTranslatef(0.0f,0.0f,-5.0f);
	gluDisk(myDisk, 23 ,24, 4, 1);
	glPopMatrix();
	gluDisk(myDisk, 23 ,24, 4, 1);
	glColor3f(0.4f, 0.4f, 0.4f);
	glPushMatrix();
	glTranslatef(0.0f,0.0f,-4.0f);
	gluDisk(myDisk, 22 ,23, 4, 1);
	glPopMatrix();
	gluDisk(myDisk, 22 ,23, 4, 1);
	glColor3f(0.5f, 0.5f, 0.5f);
	glPushMatrix();
	glTranslatef(0.0f,0.0f,-3.0f);
	gluDisk(myDisk, 21 ,22, 4, 1);
	glPopMatrix();
	gluDisk(myDisk, 21 ,22, 4, 1);
	glColor3f(0.6f, 0.6f, 0.6f);
	glPushMatrix();
	glTranslatef(0.0f,0.0f,-2.0f);
	gluDisk(myDisk, 20, 21, 4, 1);
	glPopMatrix();
...
void draw_cylinder()//creates stadium
{
	...
	glRotatef(45.0f, 0.0f, 0.0f, 1.0f);
	glColor3f(0.2f, 0.2f, 0.2f);
	gluCylinder(myCylinder, 25 ,25, 7,4, 1);
	glColor3f(0.3f, 0.3f, 0.3f);
	gluCylinder(myCylinder, 24 ,24, 6,4, 1);
	glColor3f(0.4f, 0.4f, 0.4f);
	gluCylinder(myCylinder, 23 ,23, 5,4, 1);
	glColor3f(0.5f, 0.5f, 0.5f);
	gluCylinder(myCylinder, 22 ,22, 4,4, 1);
	glColor3f(0.6f, 0.6f, 0.6f);
	gluCylinder(myCylinder, 21 ,21, 3,4, 1);
	gluDeleteQuadric(myCylinder);
	glPopMatrix();
